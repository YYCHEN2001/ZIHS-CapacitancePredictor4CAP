...
from src.models import (train_evaluate, plot_actual_vs_predicted,
                        kfold_cv, dataset_split_10class, model_results_to_md)
...
# 初始化模型，这里使用支持向量回归
svr = SVR(C=6.97, kernel='poly', degree=2, gamma='scale', coef0=8.11, epsilon=0.46)
...
plot_actual_vs_predicted(y_train, svr.predict(X_train_scaled),
                         ...
                         '../../../reports/figures/actual vs pred fig for data_8features/svr.png')
...
# 输出markdown报告
md_path = '../../../reports/results for data_8features/svr_results.md'
